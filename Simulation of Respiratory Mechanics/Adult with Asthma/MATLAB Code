...
% Set parameters for an asthma patient
set (handles.FR, 'String','12');       % Breathing frequency (slightly reduced)
set (handles.PEEP, 'String','5');      % Positive end-expiratory pressure (slightly elevated)
set (handles.PP, 'String','15');       % Peak pressure (increased to overcome resistance)
set (handles.E, 'String','2');         % I:E ratio (longer expiration)
set (handles.RMV, 'String','0');       % Reset RMV (will be calculated)
set (handles.CL, 'String','0.06');     % Lung compliance (reduced from normal)
set (handles.Cw, 'String','0.1');      % Chest wall compliance (unchanged)
set (handles.Rc, 'String','10');       % Central airway resistance (elevated)
set (handles.Rp, 'String','1.5');      % Peripheral resistance (elevated)
set (handles.Cs, 'String','0.004');    % Small airway compliance (may also be reduced)
