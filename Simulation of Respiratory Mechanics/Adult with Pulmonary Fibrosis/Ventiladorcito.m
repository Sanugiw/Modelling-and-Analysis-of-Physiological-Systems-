...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Set parameters for a pulmonary fibrosis patient
set (handles.FR, 'String','25');       % Breathing frequency (increased due to rapid shallow breathing)
set (handles.PEEP, 'String','5');      % Positive end-expiratory pressure (to maintain alveolar recruitment)
set (handles.PP, 'String','25');       % Peak pressure (elevated due to low compliance)
set (handles.E, 'String','2');         % I:E ratio (normal or slightly prolonged expiration)
set (handles.RMV, 'String','0');       % Reset RMV (will be calculated)
set (handles.CL, 'String','0.02');     % Lung compliance (markedly reduced)
set (handles.Cw, 'String','0.1');      % Chest wall compliance (unchanged)
set (handles.Rc, 'String','3');        % Central airway resistance (normal to mildly elevated)
set (handles.Rp, 'String','0.5');      % Peripheral resistance (normal to mildly elevated)
set (handles.Cs, 'String','0.004');    % Series compliance (unchanged)
